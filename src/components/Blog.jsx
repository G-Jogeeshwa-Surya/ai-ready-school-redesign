...
const posts = [
  {
    ...
    link: "https://www.aireadyschool.com/blog/personalisation-beyond-content-the-4-dimensions-every-school-should-track"
  },
  {
    ...
    link: "https://www.aireadyschool.com/blog/teacher-first-how-ai-should-empower-educators-not-replace-them"
  },
  {
    ...
    link: "https://www.aireadyschool.com/blog/why-ai-should-make-children-think-not-give-them-answers"
  }
];
    ...
    <section id="blog" className="py-24 bg-[#CBD5E1] border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12">
          ...
          <a href="https://www.aireadyschool.com/blog" target="_blank" rel="noopener noreferrer" className="hidden md:flex items-center gap-2 text-primary-600 font-medium hover:text-primary-700 transition">
        ...
        <div className="mt-8 text-center md:hidden">
          <a href="https://www.aireadyschool.com/blog" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-primary-600 font-medium hover:text-primary-700 transition">
            View All Articles <ArrowRight className="h-4 w-4" />
          </a>
        </div>
      </div>
