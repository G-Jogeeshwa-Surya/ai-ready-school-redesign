...
const Navbar = () => {
  ...
  return (
    <nav className="absolute md:fixed w-full bg-[#E2E8F0]/80 backdrop-blur-md z-50 border-b border-slate-200">
              ...
              <div className="flex items-center space-x-6 relative">
                ...
                >
                  ...
                  {showPlatformDropdown && (
                    <div className="absolute top-full left-0 w-[650px] bg-[#E2E8F0] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-100 p-6 flex transition-all duration-200">
                      {/* Left Column - Tools */}
                      <div className="w-3/5 pr-6 border-r border-slate-200 border-dashed">
                        ...
                        <div className="space-y-1">
                          <a href="https://www.aireadyschool.com/learning-hub" target="_blank" rel="noopener noreferrer" className="block p-3 rounded-xl hover:bg-[#CBD5E1] transition-colors">
                          ...
                          <a href="https://www.aireadyschool.com/creative-hub" target="_blank" rel="noopener noreferrer" className="block p-3 rounded-xl hover:bg-[#CBD5E1] transition-colors">
                          ...
                          <a href="https://www.aireadyschool.com/project-hub" target="_blank" rel="noopener noreferrer" className="block p-3 rounded-xl hover:bg-[#CBD5E1] transition-colors">
                            <h4 className="font-bold text-slate-900">Project Hub</h4>
                            <p className="text-sm text-slate-500">Coding & Model Playgrounds</p>
                          </a>
                          <a href="https://www.aireadyschool.com/research-hub" target="_blank" rel="noopener noreferrer" className="block p-3 rounded-xl hover:bg-[#CBD5E1] transition-colors">
                      ...
                      <div className="w-2/5 pl-6 flex flex-col">
                        ...
                        {/* Highlights Card */}
                        <a href="https://www.aireadyschool.com/why-ai-ready-school" target="_blank" rel="noopener noreferrer" className="mt-auto block bg-[#CBD5E1] rounded-xl p-4 border border-slate-100 text-center relative overflow-hidden group hover:bg-slate-100 transition-colors">
      ...
      {isOpen && (
        <div className="md:hidden bg-[#E2E8F0] border-b border-slate-200 shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="#platform" className="block px-3 py-2 rounded-md text-base font-medium text-slate-700 hover:text-primary-600 hover:bg-[#CBD5E1]">AI For Schools (Ecosystem)</a>
            <a href="https://www.aireadyschool.com/use-cases" target="_blank" rel="noopener noreferrer" className="block px-3 py-2 rounded-md text-base font-medium text-slate-700 hover:text-primary-600 hover:bg-[#CBD5E1]">Use Cases</a>
            <a href="https://www.aireadyschool.com/blog" target="_blank" rel="noopener noreferrer" className="block px-3 py-2 rounded-md text-base font-medium text-slate-700 hover:text-primary-600 hover:bg-[#CBD5E1]">Blog</a>
          </div>
