          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block ml-10">
              <div className="flex items-center space-x-6 relative">
                    ...
                    <div className="absolute top-full left-0 w-[650px] bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-100 p-6 flex transition-all duration-200">
                      ...
                      <div className="w-3/5 pr-6 border-r border-slate-200 border-dashed">
                        ...
                        <div className="space-y-1">
                          <a href="https://www.aireadyschool.com/learning-hub" className="block p-3 rounded-xl hover:bg-slate-50 transition-colors">
                          ...
                          <a href="https://www.aireadyschool.com/creative-hub" className="block p-3 rounded-xl hover:bg-slate-50 transition-colors">
                          ...
                          <a href="https://www.aireadyschool.com/project-hub" className="block p-3 rounded-xl hover:bg-slate-50 transition-colors">
                            <h4 className="font-bold text-slate-900">Project Hub</h4>
                            <p className="text-sm text-slate-500">Coding & Model Playgrounds</p>
                          </a>
                          <a href="https://www.aireadyschool.com/research-hub" className="block p-3 rounded-xl hover:bg-slate-50 transition-colors">
                      ...
                      <div className="w-2/5 pl-6 flex flex-col">
                        ...
                        <a href="https://www.aireadyschool.com/become-a-partner" className="text-primary-600 font-semibold mb-4 hover:text-primary-700">Become a Partner</a>
                        <a href="https://www.aireadyschool.com/our-partners" className="text-slate-600 font-semibold mb-6 hover:text-primary-600">Our Clients</a>
                        
                        {/* Highlights Card */}
                        <a href="https://www.aireadyschool.com/why-ai-ready-school" className="mt-auto block bg-slate-50 rounded-xl p-4 border border-slate-100 text-center relative overflow-hidden group hover:bg-slate-100 transition-colors">
                ...
                <a href="#use-cases" className="text-slate-600 hover:text-primary-600 px-3 py-2 rounded-md font-medium transition-colors">Use Cases</a>
                <a href="#blog" className="text-slate-600 hover:text-primary-600 px-3 py-2 rounded-md font-medium transition-colors">Blog</a>
              </div>
            </div>
          </div>
          
          <div className="hidden md:flex items-center gap-4">
            <a href="https://app.aireadyschool.com/sign-in" className="text-slate-600 hover:text-[#0F172A] font-medium px-4 py-2">Sign in</a>
            <a href="https://www.aireadyschool.com/demo" className="btn-primary rounded-full px-6 py-2.5 font-medium shadow-sm">
              Schedule a Call
            </a>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-slate-200 shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="#use-cases" className="block px-3 py-2 rounded-md text-base font-medium text-slate-700 hover:text-primary-600 hover:bg-slate-50">Use Cases</a>
            <a href="#blog" className="block px-3 py-2 rounded-md text-base font-medium text-slate-700 hover:text-primary-600 hover:bg-slate-50">Blog</a>
          </div>
          <div className="pt-4 pb-4 border-t border-slate-200">
            <div className="flex flex-col gap-3 px-5">
              <a href="https://app.aireadyschool.com/sign-in" className="block text-center text-base font-medium text-slate-600 hover:text-slate-900">Sign in</a>
              <a href="https://www.aireadyschool.com/demo" className="block btn-primary text-center px-4 py-3 rounded-xl font-medium">
                Schedule a Call
              </a>
            </div>
          </div>
